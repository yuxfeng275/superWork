...
import { Refresh, MagicStick, CircleCheck, Promotion, CopyDocument } from '@element-plus/icons-vue'
  ...
  <div class="weekly-report-page" v-loading="loading">
    ...
    <div class="page-header">
      <div class="header-left">
        <el-date-picker
          ...
          type="date"
          placeholder="选择本周任意日期"
          :clearable="false"
          :first-day-of-week="1"
          style="width: 180px"
          @update:model-value="onWeekChange"
        />
        <span class="period-label" v-if="report">
          {{ report.weekStartDate }} ~ {{ report.periodEndDate }}
        </span>
      ...
      <div class="header-actions">
        <el-button :icon="Refresh" @click="loadReport(); loadFacts()">刷新</el-button>
        <el-button
          type="primary"
          :icon="MagicStick"
        ...
        <el-button
          ...
          @click="confirmReport"
        >确认</el-button>
        <el-button :icon="CopyDocument" @click="copyReport">复制周报全文</el-button>
      </div>
    </div>
    ...
    <div class="page-body">
      ...
      <div class="main-column">
        ...
        <el-card shadow="never" class="section-card">
          <template #header>
            <div class="card-header">
              <span>人工输入</span>
              <el-button size="small" :loading="savingInputs" @click="saveInputs">保存输入</el-button>
            </div>
          </template>
          <el-input
        ...
        <el-card shadow="never" class="section-card" v-loading="factsLoading">
          ...
          <div v-if="facts" class="facts-panel">
            <div class="fact-block">
              ...
              <el-table :data="facts.keyMatters" size="small" max-height="260">
            ...
            <el-empty v-else description="上周无周报记录" :image-size="40" />
          </div>
        ...
        <!-- 历史 -->
        <el-card shadow="never" class="section-card">
          <template #header><span>历史周报</span></template>
          <el-table :data="history" size="small" max-height="240">
            ...
            <el-table-column label="语雀" min-width="120">
              <template #default="{ row }">
            ...
            <el-table-column label="操作" width="90">
              <template #default="{ row }">
                <el-button size="small" link type="primary" @click="onWeekChange(row.weekStartDate)">查看</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
      ...
      <div class="side-column">
        <el-card shadow="never" class="section-card">
          <template #header><span>发布与同步</span></template>

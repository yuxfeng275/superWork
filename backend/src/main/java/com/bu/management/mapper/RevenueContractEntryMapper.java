    ...
    @Insert("""
            ...
            INSERT INTO revenue_contract_entry
                (batch_id, contract_no, detail_no, contract_name, brand, customer, item_desc,
                 biz_line_raw, sales_owner, biz_line_id, project_id, receivable_amount, sale_month, receivable_date, service_end_date, delivery_date,
            ...
            <foreach collection="list" item="e" separator=",">
                (#{e.batchId}, #{e.contractNo}, #{e.detailNo}, #{e.contractName}, #{e.brand}, #{e.customer},
                 ...
                 #{e.saleMonth}, #{e.receivableDate}, #{e.serviceEndDate}, #{e.deliveryDate},

...
class EmailQueryServiceTest {
    ...
    void anotherUsersMessageIdIsReportedAsNotFound() {
        ...
        EmailQueryService service = new EmailQueryService(mapper, new ObjectMapper(), mock(EmailInterpretationService.class), mock(com.bu.management.mapper.ProjectMapper.class));
